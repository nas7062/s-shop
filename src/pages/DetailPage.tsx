  ...
  return (
    <div className="mx-auto  ">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <section className="lg:col-span-2 bg-white rounded-2xl shadow p-4 flex items-center justify-center">
          <img
            src={product.image}
            alt={product.title}
            className="w-full max-w-xl aspect-square object-cover rounded-xl"
          />
        </section>
      ...
      <section className="mt-8 bg-white rounded-2xl shadow">
        {/* 탭 헤더 */}
        <div className="grid grid-cols-3 text-center text-sm font-medium overflow-hidden rounded-t-2xl border-b">
          {TABS.map((tab) => (
            <button
              key={tab}
              type="button"
